  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE INDEX IF NOT EXISTS `index_comments_productId` ON `comments` (`productId`)");
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoProducts.equals(_existingProducts)) {
          return new RoomOpenHelper.ValidationResult(false, "products(com.example.android.persistence.db.entity.ProductEntity).\n"
                  + " Expected:\n" + _infoProducts + "\n"
                  + " Found:\n" + _existingProducts);
        }
        ...
        if (!_infoProductsFts.equals(_existingProductsFts)) {
          return new RoomOpenHelper.ValidationResult(false, "productsFts(com.example.android.persistence.db.entity.ProductFtsEntity).\n"
                  + " Expected:\n" + _infoProductsFts + "\n"
        ...
        _columnsComments.put("productId", new TableInfo.Column("productId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsComments.put("text", new TableInfo.Column("text", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsComments.put("postedAt", new TableInfo.Column("postedAt", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoComments.equals(_existingComments)) {
          return new RoomOpenHelper.ValidationResult(false, "comments(com.example.android.persistence.db.entity.CommentEntity).\n"
                  + " Expected:\n" + _infoComments + "\n"
                  + " Found:\n" + _existingComments);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "3e1095fcd74edb0edc506f32734f3379", "15819329ead083a61a69536b3c433398");
